...
public class Application01 {
    public static void main(String[] args) {
        ...
        *  논리값(true or false)를 취급하는 연산자이다.*/
        ...
        /*필기.
        *  논리 연산자의 종류
        *  1. 논리 연결 연산자 : 두개의 피연산자를 가지는 이항연산자이며, 연산자의 결합방향은 왼쪽에서 오른쪽으로
        *   두개의 논리식을 판단하여 참과 거짓을 판단한다.
            1-1. &&(논리 AND) 연산자 : 두개의 논리식 모두 참 일 경우 참을 반환, 둘 중 하나라도 거짓이면 거짓을
            1-2. || ( 논리OR) 연산자 : 두 개의 논리식 중 둘 중 하나라도 참 일 경우 참을 반환, 둘다 거짓이면 거짓을
           2. 논리 부정 연산자
        ...
        System.out.println("false와 false의 논리 and 연산 : " + (false && false));//모두 참일경우 참, 하나라도 거짓시 거짓
        ...
        System.out.println(" false 와 false의 논리 or 연산 : " + (false || false));  // 하나라도 참이면 참, 둘다 거짓이면 거짓

        System.out.println(" =============================================");
        System.out.println(" true의 논리 not 연산 : " + (! true));
        System.out.println(" false의 논리 not 연산 : " + (! false));  // 반대반환
    }
}

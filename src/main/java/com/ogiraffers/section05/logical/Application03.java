...
public class Application03 {
    public static void main(String[] args) {
        ...
        *  논리식 || 논리식 : 앞의 결과가 true 이면 뒤를 실행 안 함.*/
        ...
        /*목차. 1. 논리식 && 논리식 : 앞의 결과가 false 이면 뒤를 실행안함.*/
        /*필기.
        *  조건식 두 개가 모두 만족해야 true를 반환하지만, 앞에서 미리 false가 나오면
        *  뒤의 조건을 확인할 필요가 없어 false를 반환한다.
        *  따라서 연산 횟수를 줄이기 위해서는 && 연산의 경우 앞에 false가 나올 가능성이 높은편을 작성하는 것이 좋다.*/
        ...
        *  따라서 연산 횟수를 줄이기 위해서는 || 연산의 경우 앙ㅍ에 true가 나올 가능성이 높은 조건을 작성하는 편이 좋다.*/
